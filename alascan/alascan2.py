...
<!-- *********************************************************
  ...
  <table border=0 width="725" cellpadding=0 cellspacing=0px>
    <tr>
      ...
      <td colspan=1 align=right style="vertical-align:top;" width="224">
        <table align=right>
         <tr><td align=right> <font style="font-size:small;">Kortemme Lab Server</font></td></tr>
         <tr><td align=right> <A href="../../backrub/"> <font style="font-size:small;">Structure Prediction Backrub</font></A></td></tr> 
         <tr><td bgcolor="#447DAE" align=right><font style="font-size:small; color:#FFFFFF;">Interface Alanine Scanning</font></td></tr>
         <tr><td align=right> <A href="http://kortemmelab.ucsf.edu/"><font style="font-size:small;">more server soon</font></A></td></tr>
        </table>
      </td>
    </tr>
...
def make_menu(SID):
  ...
  if result[0][0]:
    ...
    html += """[&nbsp;<A href="alascan2.py?query=update">User Information</A>&nbsp;] &nbsp;&nbsp;&nbsp;\n"""
    html += """[&nbsp;<A href="alascan2.py?query=logout">Logout</A>&nbsp;]\n"""
  else:
    html += """[&nbsp;<A href="alascan2.py?query=login">Login</A>&nbsp;] &nbsp;&nbsp;&nbsp;\n"""
    html += """[&nbsp;<A href="alascan2.py?query=register">Register</A>&nbsp;]\n"""
...
def make_footer():
  html="""
    ...
    <tr>
      <td align=center><img src="../images/horzline_long.jpg" border=0><p>
         Robetta is available for NON-COMMERCIAL USE ONLY at this time<br>
         <font color=#666688><b>[</b></font> 
            <A href="alascan2.py?query=terms_of_service" class="nav">Terms of Service</A> 
         <font color=#666688><b>]</b></font><br>
         <small>Copyright &copy; 2008 University of California San Francisco, <A href="mailto:kortemme@u.washington.edu" style="font-size: 8pt">Tanja Kortemme</a>, <A href="mailto:lauck@cgl.ucsf.edu" style="font-size: 8pt">Florian Lauck</A></small>
         </center>
      </td>
    </tr>
  </table>
