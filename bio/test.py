...
for x in range(0, len(ddG_pdb_ids)):
    ddG_pdb_id = ddG_pdb_ids[x]
    print(x, ddG_pdb_id)
    rr = ResidueRelatrix(ddG_pdb_id, rosetta_scripts_path, rosetta_database_path, min_clustal_cut_off = 80, cache_dir = '/home/oconchus/temp')
