...
def test_ddg_pdb_ids():
    ...
    fix_later = set([
        ...
        '1BRH', # Rosetta bug where the terminal residue has an incomplete set of ATOMs and is then removed. Bug is in chains B & C.
        '1BRI', # Rosetta bug where the terminal residue has an incomplete set of ATOMs and is then removed. Bug is in chains A & B.
        '1BRJ', # Rosetta bug where the terminal residue has an incomplete set of ATOMs and is then removed. Bug is in chains A & B.
        '1BRK', # Rosetta bug where the terminal residue has an incomplete set of ATOMs and is then removed. Bug is in chain B.
        ...
        '1CHO', # This needs investigation. 'Relatrix construction failed creating the PDBUniParcSequenceAligner object for 1CBW.'. File "/home/oconchus/dev/tools/bio/uniprot.py", line 88, in uniprot_map: assert(len(v) == len(set(v)))
        '1DKG',
        '1DTD',
        '1JTD',
        '1JTG',
        ...
        '1CPM', # This needs investigation. Could not align
        '1DEQ', # ClustalO failure - probably due to chain M
        '2PGK', # ClustalO failure - probably due to chain A

        # Low matches
        '1DVF', # chain A
        '1G6V', # chain A looks like it has lots of mismatches
        '1MCP',
        '1MSI',
        '1QU0', #83%
        '1VFB', # 0%
        ...
        # PDB->ACC mapping failed
        '1YYJ', # NMR no mapping in the PDB file
        '2IMM', # X-ray no mapping in the PDB file
        ...
        '1XY1',
        '2ATC',
        '2MBP', # superceded by 1ANF
        '2MLT',
        '4CPA',

        # Ambiguous matches - the sequences are too close
        '1KJ1',
        '1Z1I', # only 1 chain?

        # NMR
        '1K42', # lots of mismatches?

        # UniProt XML parsing
        '1M7T',
        '2TRX',

        # The residue mapping failed :-(
        '1OLR'
        ])
