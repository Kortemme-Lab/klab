...
# When they are set, the columns correspond respectively to the description from the Rosetta 3.3 manual, a related comment in ScoreType.hh, and a list of the .wts files in which the terms are present.
