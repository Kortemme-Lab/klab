...
BIN_DIR = sys.argv[0][:-11]  # "/opt/rosettabackend/bin/ensdes5.py"
...
MAKE_RESFILE_SCRIPT = "%s/makeResfile.pl" % BIN_DIR
PDBLITE_SCRIPT = "%s/PDBlite.py" % BIN_DIR
CONCAT_PDB_SCRIPT = "%s/concat-mult-pdbs.py" % BIN_DIR
PARSE_NEIGHBOR_SCRIPT = "%s/parse_neighbors.py" % BIN_DIR
...
try:
    usage = "usage: %prog starting_pdb_file num_structs max_segment_length num_steps temp num_designs_per_struct [options]"
    ...
    DEBUG = options.debug
    starting_pdb_file, num_structs, maxres, num_steps, kt, num_designs_per_bb = args
